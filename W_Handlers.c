...
*
* Print a character to the buffer, considering formatting options.
*
...
*
* This function prints a number to the specified output buffer,
...
*
* Write an unsigned number to the buffer with formatting options.
*
* @is_negative: Indicate if number is negative
* @ind: Start index in buffer
* @buffer: Output buffer
